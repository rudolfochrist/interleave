...
If you want to add some notes to the current page you can type <kbd>i</kbd>. This will create a new headline for your notes. If some notes are already present, ~i~ will swith over to the other buffer.
